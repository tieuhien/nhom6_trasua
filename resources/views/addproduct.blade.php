...
@else
    ...
    <div class="container1">
            <form method="post" action="ProductsController" enctype="multipart/form-data">
                <div class="logo"><img src="resource/images/logo.png" alt="logo" class="logo1"></div>
                <div class="login">Thêm sản phẩm</div><br>
                @if(count($errors)>0)
                <div class="noti_err">
                    <script>
                ...
                @endif
                <div class="form-group"><p>Tên hiển thị: <input type="text" name="name" class="input1" autofocus placeholder="vd: Trà sữa phân châu mattra"> </p> </div>
                <div class="form-group"><p>Giá: <input type="number" name="price" class="input1" placeholder="50000"></p></div>
                ...
                <div class="form-group"><p>Size: <input type="text" name="size" class="input1" title="Phân cách nhau bởi dấu cách" placeholder="S M L"></p> </div>
                <div class="form-group"><p>Ảnh sản phẩm: <input type="file" name="images" class="input1"   multiple></p> </div>
                <input type="hidden" name="_token" value="{{csrf_token()}}">
                <div class="form_bottom">
                    <button class="submit" type="submit" name="edit" formmethod="post" title="Lưu sản phẩm luôn.">Đăng bán</button> 
