...
<div id="sidebar">
	<h3>GIỎ HÀNG</h3>
    <div id="cart">
    	<span class="empty">Không có sản phẩm trong giỏ hàng.</span>       
    </div>
    
    <h3>DANH MỤC</h3>
    <div class="checklist categories">
    	<ul>
    		<!-- get danh muc tu app/http/providers/AppseviceProvider.php-->
    		@foreach($danhmuc as $loai)
                <li><a href="/products/{{$loai->id}}"><span></span>{{$loai->name}}</a></li>
            @endforeach
        </ul>
    </div>
    
    <h3>TÌM KIẾM</h3>
    <span><form action="searchC" method="get"><input type="text" name="key" placeholder="Tìm kiếm"></form></span>
...
<div id="grid-selector">
       <div id="grid-menu">
       	   Chế độ xem:
           <ul>           	   
               <li class="largeGrid" title="Đầy đủ"><a href=""></a></li>
               <li class="smallGrid" title="Lưới nhỏ"><a class="active" href=""></a></li>
           </ul>
       </div>
       Hiển thị {{$products->firstItem()}}-{{$products->perPage()}} của 
...
@foreach($products as $sp)
	<div class="product" style="z-index: 1;">
    	<div class="info-large">
        	<h4>{{$sp->name}}</h4>
            <div class="sku">
            	PRODUCT SKU: <strong>DT{{$sp->id}}</strong>
            </div>
             
            <div class="price-big">
            	<span><?php echo $old_price=$sp->price+10000; ?>đ</span> {{$sp->price}}đ
            </div>
            ...
            <button class="add-cart-large" >Thêm vào giỏ</button>                          
                         
        </div><!-- end div info-learn ---->

        <div class="make3D">
            <div class="product-front">
                <div class="shadow"></div>
                <img src="resource/images/products/{{$sp->image_link}}" alt="ảnh sản phẩm {{$sp->name}}">
                <div class="image_overlay"></div>
                <div class="add_to_cart">Thêm vào giỏ</div>
                <div class="view_gallery">Xem thêm ảnh</div>                
                <div class="stats">        	
                    <div class="stats-container">
                        <span class="product_price">{{$sp->price}}đ</span>
                        <span class="product_name">{{$sp->name}}</span>    
                        <p>{{$sp->catalog_name}}</p>                                            
            ...
            <div class="product-back">
                ...
                <div class="carousel">
                    <ul class="carousel-container" rel="0" style="width: 945px;">
                        <li><img src="resource/images/products/{{$sp->image_link}}" alt=""></li>
                        <li><img src="resource/images/products/{{$sp->image_link}}" alt=""></li>
                        <li><img src="resource/images/products/{{$sp->image_link}}" alt=""></li>
                    </ul>
...
#grid::-webkit-scrollbar,#sidebar::-webkit-scrollbar { 
    display: none; 
} 
...
.cart-item strong{color:#000; font-size:16px;}
.cart-item span{
	color: #393c45;
    display: block;
    font-size: 14px;
